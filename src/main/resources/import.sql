...
-- Projects
-- ---------------------------------------------------
INSERT INTO project (app_user_uuid, name, description, log_id, archived) VALUES ('dev-001', 'Project Alpha', 'Description of Project Alpha', 1,FALSE);
INSERT INTO project (app_user_uuid, name, description, log_id, archived) VALUES('dev-001','Project Beta', 'Description of Project Beta', 2, FALSE);
INSERT INTO project (app_user_uuid, name, description, log_id, archived) VALUES ('dev-001', 'Project Gamma', 'Description of Project Gamma', 3, FALSE);

-- ---------------------------------------------------
-- Goals (5 per project)
-- ---------------------------------------------------
-- Project 1
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (1,1,'Goal 1 for Alpha',0,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (2,1,'Goal 2 for Alpha',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (3,1,'Goal 3 for Alpha',2,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (4,1,'Goal 4 for Alpha',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (5,1,'Goal 5 for Alpha',0,NULL);
-- Project 2
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (6,2,'Goal 1 for Beta',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (7,2,'Goal 2 for Beta',2,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (8,2,'Goal 3 for Beta',0,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (9,2,'Goal 4 for Beta',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (10,2,'Goal 5 for Beta',2,NULL);
-- Project 3
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (11,3,'Goal 1 for Gamma',0,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (12,3,'Goal 2 for Gamma',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (13,3,'Goal 3 for Gamma',2,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (14,3,'Goal 4 for Gamma',1,NULL);
INSERT INTO goal (id, project_id, description, priority, estimated) VALUES (15,3,'Goal 5 for Gamma',0,NULL);
...
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (1,'dev-001',4,'Event 1','Description 1',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (2,'dev-001',5,'Event 2','Description 2',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (3,'dev-001',6,'Event 3','Description 3',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (4,'dev-001',7,'Event 4','Description 4',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (5,'dev-001',8,'Event 5','Description 5',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (6,'dev-001',9,'Event 6','Description 6',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (7,'dev-001',10,'Event 7','Description 7',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (8,'dev-001',11,'Event 8','Description 8',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (9,'dev-001',12,'Event 9','Description 9',CURRENT_DATE,NULL,NULL,FALSE);
INSERT INTO event (id, app_user_uuid, log_id, name, description, start, duration, finish_time, timed) VALUES  (10,'dev-001',13,'Event 10','Description 10',CURRENT_DATE,NULL,NULL,FALSE);
